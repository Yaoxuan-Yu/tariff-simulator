...
import {
  mockCalculateTariff,
  getCountriesForSource,
  getProductsForSource,
  getBrandsForProductAndSource,
} from "@/lib/mock-api"
...
export function TariffCalculatorForm({ onCalculationComplete }: TariffCalculatorFormProps) {
  ...
  const products = getProductsForSource(formData.tariffSource)
  const countries = getCountriesForSource(formData.tariffSource)
  ...
  const handleInputChange = (field: string, value: string) => {
    ...
    if (field === "product") {
      const brands = getBrandsForProductAndSource(value, formData.tariffSource)
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      console.log(" Calling mockCalculateTariff with:", formData) // Debug log
      const response = await mockCalculateTariff({ ...formData, tariffSource: formData.tariffSource })
