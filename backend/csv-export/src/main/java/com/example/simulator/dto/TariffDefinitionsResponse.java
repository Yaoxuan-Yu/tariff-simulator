...
/**
 * Mirror of the simulator-tariffs TariffDefinitionsResponse to allow
 * session deserialization in services that do not own the simulator module.
 */
public class TariffDefinitionsResponse implements Serializable {
