package com.example.insights.entity;
...
public class Tariff implements Serializable {
    ...
    public Double getAhsWeighted() {
        return ahsWeighted;
    }

    public void setAhsWeighted(Double ahsWeighted) {
        this.ahsWeighted = ahsWeighted;
    }

    public Double getMfnWeighted() {
        return mfnWeighted;
    }

    public void setMfnWeighted(Double mfnWeighted) {
