package com.example.insights.integration;
...
@ActiveProfiles("test")
@Testcontainers
public class TradeInsightsControllerIntegrationTest {
    ...
    void testSearchTradeInsights_Success() throws Exception {
        TradeInsightsRequest request = new TradeInsightsRequest();
    ...
    @Test
    void testSearchTradeInsights_InvalidQuery() throws Exception {
        TradeInsightsRequest request = new TradeInsightsRequest();
        request.setQuery(""); // Empty query
